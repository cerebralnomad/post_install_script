...
# Run with sudo
# This script is for distros other than Kubuntu or other Plasma based DEs
# The only difference is here Latte Dock, Yakuake, and the Kubuntu backports PPA are not installed
